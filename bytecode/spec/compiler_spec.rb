...
RSpec.describe Compiler do
  ...
  it 'compiles a STORE instruction' do
    expect(compile("store %1, 33")).to eq([OpCodes::STORE, 1, 33, 0])
  end

  it 'compiles a PRINT instruction' do
    expect(compile("print %1")).to eq([OpCodes::PRINT, 1])
  end
